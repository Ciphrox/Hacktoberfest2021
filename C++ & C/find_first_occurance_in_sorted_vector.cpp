...
int main(){
    ...
    int idx;
    if((idx = find_first_occurance(v, 2)) != -1)
        cout << "First occurance of 2 in vector v is at index " << idx << endl;
    else
        cout << "2 is not present in vector v.\n";
    
    if((idx = find_first_occurance(v, 30)) != -1)
        cout << "First occurance of 30 in vector v is at index " << idx << endl;
    else
