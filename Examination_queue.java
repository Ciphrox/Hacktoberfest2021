...
public class Examination_queue {     // Main class
    ...
    public static void main(String[] args) {
        ...
        List<String> entries = new ArrayList<>();   //  Assign a array list as 'entries'
        ...
        if (result_set.isEmpty()) {  // Check if the queue is empty
            ...
            for (Examination sheet:result_set) {                         // iterate through each entry
...
class Priorities {      // Class to assign priorities
    ...
    // Implement a method to process all the inputted entries and return the entries yet to be served in the priority order
